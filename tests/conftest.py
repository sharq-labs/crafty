...
STATIC_GUARDS: dict[str, frozenset[str]] = {
    ...
    # EXEC-SPEC-STRUCTURED. Same split: the measurement is records work, and
    # what costs seconds is launching an interpreter per column.
    "tests/test_exec_spec_structured_input.py": frozenset(
        {
            "test_the_reader_extension_imports_no_domain_and_no_probe",
            "test_adding_two_consumers_required_editing_a_reader",
            "test_the_constitutive_matrix_is_derivable_and_therefore_not_residue",
            "test_the_stoichiometric_matrix_is_not_derivable_and_therefore_is_residue",
            "test_a_reader_without_stoichiometry_reports_a_false_conservation_violation",
            "test_every_residue_item_carries_all_nine_attributes",
            "test_every_residue_item_names_a_failed_attempt",
            "test_the_two_residue_tables",
            "test_connectivity_carries_body_identity_in_the_representation_measured",
            "test_the_body_has_no_carrier_and_the_note_says_so",
            "test_the_fresh_process_never_loads_the_probes",
            "test_the_identity_digest_does_not_cover_a_solver_choice",
            "test_the_numerics_payload_is_required_and_typed",
            "test_the_bulk_asymmetry_is_not_claimed_on_dtype",
            "test_the_candidate_table_is_labelled_as_carrying_little_weight",
            "test_inj_3_the_stiffness_is_assembled_from_the_reconstructed_mesh",
            "test_inj_3_refuses_an_inverted_element_ordering",
            "test_the_shape_only_candidates_are_rejected_as_false_universality",
            "test_exactly_one_candidate_survives_and_it_is_the_existing_decision",
            "test_the_overlap_verdict_is_mixed_not_a_shared_universal_shape",
            "test_mechanics_reconstruction_is_verified_equal_against_the_probe",
            "test_inj_1_the_constitutive_matrix_is_injected_and_exact",
            "test_species_reconstruction_is_verified_equal_against_the_probe",
            "test_inj_2_the_stoichiometry_is_injected_and_reproduces_the_trajectory",
            "test_the_conserved_weights_are_recovered_from_the_reconstructed_matrix",
            "test_d_corrupted_structure_is_rejected",
            "test_d2_a_ragged_coefficient_table_is_rejected",
            "test_e_unsupported_schema_is_rejected",
            "test_the_axis_order_of_a_coefficient_table_is_not_inferable",
            "test_missing_structure_is_a_typed_failure_for_both_columns",
            "test_structure_for_the_wrong_column_does_not_silently_bind",
            "test_reconstruction_failure_is_not_a_scientific_verdict",
            "test_a_missing_initial_condition_stops_the_species_column",
            "test_g_the_reader_answers_the_mechanics_questions_where_claimed",
            "test_g2_the_reader_answers_the_species_questions_where_claimed",
            "test_g3_neither_column_can_answer_structure_without_its_payload",
            "test_h_no_universal_core_or_committed_evidence_was_modified",
            "test_no_scientific_problem_schema_moved",
            "test_no_metadata_was_used_to_carry_science",
            "test_a_persisted_problem_is_data_and_only_data",
        }
