...
def main():
    ...
    print(
        ...
        "Stacked Dual-GP Bayesian Optimization"
    )
    print("=" * 108)
    print(
    ...
    print(
        f"Final RBF weight         : {result['final_weight_rbf']:.4f}"
    )
    print(
        f"Final Matern weight      : {result['final_weight_matern']:.4f}"
    )
    print(
